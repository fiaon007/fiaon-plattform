...
const FiaonLanding = lazy(() => import("@/pages/fiaon-landing"));
...
const CookieEinstellungenPage = lazy(() => import("@/pages/cookie-einstellungen"));
const PasswortVergessenPage = lazy(() => import("@/pages/passwort-vergessen"));
...
const ZahlungPage = lazy(() => import("@/pages/zahlung"));
const ZahlungDankePage = lazy(() => import("@/pages/zahlung").then((m) => ({ default: m.ZahlungDankePage })));
const NummerAktualisierenPage = lazy(() => import("@/pages/nummer-aktualisieren"));
