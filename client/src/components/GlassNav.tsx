...
export default function GlassNav({ activePage = "startseite" }: GlassNavProps) {
  ...
  return (
    <>
      ...
      >
        <div className="max-w-[1120px] mx-auto px-4 sm:px-6 py-3">
          {/* Glass pill container */}
          <div
            className={`fiaon-glass-nav rounded-2xl transition-all duration-500 ${
              scrolled ? "shadow-lg" : ""
            }`}
          >
      ...
      {showModal && (
        ...
        >
          <div className="fiaon-modal max-w-[440px]">
            <div className="text-center mb-6">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#2563eb] to-[#1d4ed8] flex items-center justify-center mx-auto mb-4">
            ...
            <div className="space-y-3">
              ...
              <a
                href="/antrag"
                className="group block w-full p-4 rounded-2xl border border-gray-100 hover:border-[#2563eb]/20 bg-white hover:bg-blue-50/30 transition-all duration-300"
              >
                <div className="flex items-center justify-between">
                  ...
                  <svg
                    ...
                    strokeWidth="2"
                    strokeLinecap="round"
                    className="group-hover:stroke-[#2563eb] group-hover:translate-x-0.5 transition-all"
                  >
              ...
              {/* Geschäftskunde */}
              <div className="relative block w-full p-4 rounded-2xl border border-gray-100 bg-gray-50/50 opacity-70 cursor-not-allowed">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-[15px] font-semibold text-gray-900 mb-0.5">
                      Als Geschäftskunde
                  ...
                  <span className="text-[10px] font-semibold uppercase tracking-wider text-gray-400 bg-gray-100 px-2.5 py-1 rounded-full">
                    Bald verfügbar
                  </span>
                </div>
              </div>
            ...
            <button
              ...
              className="w-full mt-4 py-2.5 text-[13px] font-medium text-gray-400 hover:text-gray-600 transition-colors"
            >
              Abbrechen
            </button>
          </div>
