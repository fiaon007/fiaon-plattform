...
const de = {
  ...
  paketeLead: "Jedes Paket ist ein Betreuungsauftrag zum Festpreis — alle Gebühren und die Honorare unserer Partner inklusive. Die Planungsgröße ist der Rahmen, den Sie anstreben; danach richten sich Dauer und Tiefe unserer Begleitung. Über jeden Rahmen entscheiden die Institute.",
...
const en: typeof de = {
  ...
  paketeLead: "Each package is a support engagement at a fixed price — all fees and our partners’ charges included. The planning figure is the limit you are aiming for; it determines how long and how closely we work with you. Every limit is decided by the institutions.",
