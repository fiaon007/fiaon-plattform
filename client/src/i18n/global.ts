...
const de = {
  ...
  lead: "Gründung, EIN und ITIN, Bankkonto und Firmenkarten in den USA — umgesetzt von unserem Team in Miami, unseren Partner-Anwälten und Partner-Steuerberatern. Sie haben einen Ansprechpartner, einen Vertrag nach deutschem Recht und einen Festpreis, alle Gebühren inklusive.",
...
const en: typeof de = {
  ...
  lead: "Formation, EIN and ITIN, bank account and business cards in the United States — handled by our team in Miami, our partner lawyers and partner tax advisers. You have one contact, one contract under German law and one fixed price, all fees included.",
  ...
  vertrauenZusatz: { text: "Team on the ground in Miami", pfad: "" },
  ...
  vertragVorab: "You see the full contract before you sign.",
  mustervertragLesen: "",
