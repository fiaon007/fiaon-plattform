...
const de = {
  ...
  globalKosten: "Staatliche Gebühren, Registered Agent sowie die Honorare von Steuerberatern und Anwälten sind im Paketpreis nicht enthalten und werden vor dem Start ausgewiesen.",
...
const en: typeof de = {
  ...
  globalKosten: "State fees, the registered agent and the fees of tax advisers and lawyers are not included in the package price and are itemised before work starts.",
