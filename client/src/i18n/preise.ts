...
const de = {
  ...
  preisHinweis: "Alle Preise inklusive Umsatzsteuer. Zwölf Raten, jede per Überweisung, monatlich kündbar. Über Konto, Karte und Rahmen entscheidet die Bank – FIAON bereitet vor. Preise gelten in Deutschland, Österreich und der Schweiz (Abrechnung in Euro).",
  antragHinweis: "",
...
const en: typeof de = {
  ...
  preisHinweis: "All prices include VAT. Twelve instalments, each by bank transfer, cancellable monthly. The bank decides on account, card and limit — FIAON prepares. Prices apply in Germany, Austria and Switzerland (billed in euros).",
