...
const de = {
  ...
  zahlen: [
    ...
    { wert: "12 Raten", label: "monatlich per Überweisung – danach entscheiden Sie, ob Sie bleiben" },
  ],
  ...
  vertrauenLead: "FIAON LTD mit Sitz in London, Kunden in Deutschland, Österreich und der Schweiz. Jedes Schreiben anwaltlich geprüft, jede Zahlung per Überweisung, jede Akte verschlüsselt in der EU.",
  vertrauen: [
...
const en: typeof de = {
  ...
  zahlen: [
    ...
    { wert: "12 instalments", label: "monthly by bank transfer — then you decide whether to stay" },
  ],
  ...
  vertrauenLead: "FIAON LTD, based in London, with customers in Germany, Austria and Switzerland. Every letter reviewed by lawyers, every payment by bank transfer, every file encrypted in the EU.",
  vertrauen: [
