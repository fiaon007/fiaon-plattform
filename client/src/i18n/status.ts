...
const de = {
  ...
  zeilen: [
    ...
    ["Zahlungen", "per Überweisung auf das Geschäftskonto der FIAON LTD; keine Kartendaten bei FIAON"],
  ...
  fragen: [
    ...
    { f: "Wie sind die Daten geschützt?", a: "Verschlüsselte Übertragung (TLS), verschlüsselte Speicherung, Zugriff nur für den Ansprechpartner, der Ihre Akte führt, und die Betreiber. Hochgeladene Unterlagen werden beim Hochladen geprüft. Zahlungen laufen per Überweisung auf das Geschäftskonto der FIAON LTD – FIAON speichert keine Kartendaten." },
...
const en: typeof de = {
  ...
  zeilen: [
    ...
    ["Payments", "by bank transfer to the business account of FIAON LTD; no card data at FIAON"],
  ...
  fragen: [
    ...
    { f: "How is the data protected?", a: "Encrypted transfer (TLS), encrypted storage, access only for the contact who manages your file and the operators. Uploaded documents are checked on upload. Payments are made by bank transfer to the business account of FIAON LTD – FIAON stores no card details." },
