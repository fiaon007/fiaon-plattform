...
const de = {
  ...
  pille: "Startgespräch · kostenlos, ohne Verpflichtung", h1a: "Lieber erst reden, ", h1b: "dann entscheiden Sie",
...
const en: typeof de = {
  ...
  krume: "Book a call",
  pille: "Onboarding call · free, no obligation", h1a: "Would you rather talk to ", h1b: "a person first?",
