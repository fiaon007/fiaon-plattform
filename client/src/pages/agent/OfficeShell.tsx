...
export const RAEUME: Raum[] = [
  ...
  // 09.09.2026 (E-168, Team-Feedback Punkt 4): Der Menüpunkt „Nicht erreicht" ist weg — die
  // Menschen stehen rechts in der Pipeline unter „Wieder dran", sobald ihre Wiedervorlage
  // fällig ist. Der Filter auf der Kundenseite bleibt erreichbar (/agent/kunden?filter=nicht_erreicht).
