    ...
    team: {
      ...
      bloecke: [
        tab(["Rolle", "Wer", "Aufgabe"],
          ...
          ["Leitung Forderungen & Zahlungen (Back-Office)", "Diana", "Schreiben an Gläubiger und Auskunfteien (Einschreiben), Fristen, Eskalation; täglicher Kontoabgleich, Erstattungen; Mahnwesen ab Tag 30, Sperren, Übergaben. Aufträge kommen von dir als Ticket. Feste Vergütung, keine Provisionsbeteiligung."],
