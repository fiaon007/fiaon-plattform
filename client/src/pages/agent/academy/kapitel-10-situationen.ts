...
export const KAPITEL_10: KapitelInhalt = {
  inhalte: {
    ...
    "fall-11": fall({
      ...
      aufloesung: "Reaktivierung (E-042): weich, mit ehrlicher Entschuldigung – diese Kunden haben lange gewartet, der Fehler lag bei uns. Zwei gute Ausgänge: Zahlung (Altbestand: Reaktivierungsbonus 50 % des Zahlungswerts) oder einen Monat aussetzen (0 € Vergütung, aber vorgestellt, Onboarding-Termin gebucht, Kundin gehalten). Im Onboarding ist die Bonitätsauskunft das Ziel – zahlt sie sie, kommen 10 € dazu.",
