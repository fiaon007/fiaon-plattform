...
export const KAPITEL_2: KapitelInhalt = {
  inhalte: {
    ...
    kundenbereich: {
      ...
      bloecke: [
        tab(["Bereich", "Gruppe", "Was der Kunde dort tut"],
          ...
          ["Abo & Zahlungen", "Konto", "Raten, Zahlungskalender, Zahlungsdaten, Abo kündigen."],
    ...
    rundgang: {
      ...
      uebung: { art: "rundgang", stationen: [
        ...
        { anker: "kb-abo", titel: "Warum das trägt", kunde: `${preis("pro")} im Monat per Überweisung – und in jedem Monat steht, was dafür passiert ist.`, mitarbeiter: "Nach der zwölften Rate fragt FIAON, ob er bleibt. Die Kurve beantwortet das – und deine Provision läuft weiter." },
    ...
    hintergrund: {
      ...
      bloecke: [
        tab(["Baustein", "Aufgabe", "Was du davon merkst"],
          ...
          ["Banking Circle (Geschäftskonto)", "Jede Zahlung per Überweisung mit Referenz – die erste wie jede Rate (QR/EPC, Zahlungsdaten per Mail); seit 19.09.2026 der einzige Zahlweg, kein Stripe mehr (E-037)", "Zahlungsdaten im Bereich; „bezahlt“ erst nach Kontoabgleich"],
          ["Kontoabgleich", "Täglich durch das Back-Office: Kontoauszug (Banking Circle) einspielen, Zuordnungen bestätigen", "Status springt von „Kunde meldet Zahlung“ auf „Bezahlt“; deine Provision entsteht"],
          ["Abo-Motor + Mahnstufen", "Erzeugt jede Rate, erinnert Tag 0/3/7, mahnt Tag 14/21", "Collections zeigt dir, wer an Tag 14 deinen Anruf braucht"],
  ...
  test: [
    ...
    frage("Wie wird die erste Rate bezahlt?", ["Bar beim Startgespräch", "Immer direkt per Überweisung mit Zahlungsreferenz – genau wie jede weitere Rate", "Stripe", "PayPal"], 1, "Stripe ist komplett entfernt; jede Zahlung ist eine Überweisung."),
