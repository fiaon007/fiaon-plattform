    ...
    hintergrund: {
      ...
      bloecke: [
        tab(["Baustein", "Aufgabe", "Was du davon merkst"],
          ...
          ["Banking Circle + GoCardless", "Erste Zahlung immer direkt per Überweisung mit Referenz (QR/EPC, Zahlungsdaten per Mail); SEPA-Lastschrift über GoCardless nur für Folgeraten; kein Stripe mehr (E-037)", "Zahlungsdaten im Bereich; „bezahlt“ erst nach Kontoabgleich"],
