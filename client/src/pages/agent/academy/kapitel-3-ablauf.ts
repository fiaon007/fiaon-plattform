...
export const KAPITEL_3: KapitelInhalt = {
  inhalte: {
    ...
    "lead-klassen": {
      ...
      bloecke: [
        ...
        ul(
          "Kapazität: Höchstens 10 gleichzeitig zugewiesene Kunden je Mitarbeiter in der Pipeline – wer voll ist, bekommt keine neuen, bis einer abgeschlossen ist. Termine zählen separat: Deine eingetragene Availability soll mit Terminen komplett ausgelastet sein. Für deinen Verdienst gibt es keinen Deckel.",
    ...
    provision: {
      ...
      bloecke: [
        ...
        ul(
          ...
          "Das Back-Office (Forderungen & Zahlungen) ist fest vergütet und hat keine Provisionsbeteiligung.",
  ...
  test: [
    ...
    frage("Wie viele zugewiesene Kunden hat ein Mitarbeiter höchstens gleichzeitig in der Pipeline?", ["Unbegrenzt", "10 – Termine zählen separat", "120", "50"], 1, "Die Availability soll mit Terminen voll sein; zugewiesene Kunden sind auf 10 begrenzt."),
