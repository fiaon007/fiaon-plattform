    ...
    startgespraech: {
      ...
      bloecke: [
        leitfaden(
          ...
          { titel: "6 · Abo-Klarheit", ziel: "Laufende Kosten bestätigen – der Streitfall wird hier ausgeräumt.", saetze: [`„Ihr Paket ist ein laufendes Abo: ${preis("pro")} jeden Monat, die nächste Rate ist am [Datum] fällig – Sie überweisen sie mit Ihrem Verwendungszweck.“`, "„Kündbar zum Ende des laufenden Monats, formlos – im Bereich unter Abo & Zahlungen oder per E-Mail. Kein Grund nötig.“", "„Ist das so für Sie in Ordnung?“"], hinweis: "Pflichtnotiz: seine Antwort wörtlich. Keine Mindestlaufzeit erfinden." },
