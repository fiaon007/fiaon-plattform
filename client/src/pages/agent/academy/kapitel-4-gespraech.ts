...
export const KAPITEL_4: KapitelInhalt = {
  inhalte: {
    ...
    startgespraech: {
      ...
      bloecke: [
        leitfaden(
          ...
          { titel: "6 · Abo-Klarheit", ziel: "Laufende Kosten bestätigen – der Streitfall wird hier ausgeräumt.", saetze: [`„Ihr Paket ist ein laufendes Abo: ${preis("pro")} jeden Monat, die nächste Rate ist am [Datum] fällig – Sie überweisen sie mit Ihrem Verwendungszweck.“`, "„Die Laufzeit beträgt zwölf Monate; danach ist der Vertrag monatlich kündbar – formlos im Bereich unter Abo & Zahlungen oder per E-Mail. Kein Grund nötig.“", "„Ist das so für Sie in Ordnung?“"], hinweis: "Pflichtnotiz: seine Antwort wörtlich. Die Laufzeit von zwölf Monaten nennen, nicht beschönigen." },
    ...
    zahlungserinnerung: {
      einleitung: "Die Reaktivierung: Ein Kunde mit überfälliger Rate – oft einer, der lange gewartet hat und einen schwierigen Start hatte. Ausdrücklich kein Inkasso-Ton: weich, mit Entschuldigung. Zwei gute Ausgänge: Er zahlt (Altbestand: Reaktivierungsbonus 50 % des Zahlungswerts) – oder du setzt die Rate einen Monat aus (0 €, aber du hast dich vorgestellt und den Onboarding-Termin gebucht).",
      bloecke: [
        leitfaden(
        ...
        merk("Entschuldigen → zuhören → aufräumen → zwei Wege → Termin. Wer zahlt, bringt dir 50 % des Zahlungswerts (Altbestand). Wer aussetzt, bleibt Kunde – und das ist auf zwölf Monate mehr wert."),
      ],
    },
    wortregeln: {
    ...
    einwand: {
      ...
      uebung: { art: "einwand", einwaende: [
        ...
        { einwand: "„Warum ein Abo? Ich will einmal zahlen und fertig.“", antworten: [
          ...
          { text: "„Das Abo können Sie ja sofort nach der ersten Rate kündigen.“", bewertung: "schlecht", begruendung: "Falsch seit dem 03.09.2026: Der Vertrag läuft über zwölf Monatsraten und ist erst danach monatlich kündbar. Wer das am Telefon zusagt, schließt den Vertrag auf einer falschen Auskunft – und der Kunde hat recht, wenn er sich später beschwert. Richtig: Laufzeit nennen, den Nutzen der zwölf Monate erklären und auf das 14-tägige Widerrufsrecht hinweisen." },
