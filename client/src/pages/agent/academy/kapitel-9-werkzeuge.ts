  ...
  inhalte: {
    ...
    calendar: {
      ...
      uebung: { art: "uebung", raum: { href: "/agent/arbeitszeiten", label: "Availability öffnen" }, schritte: [
        ...
        "Verstehe die Buchung: Hat der Kunde schon einen Betreuer, sieht er nur dessen Zeiten; sonst Round-Robin nach Kapazität, Quote, Sprache/Land. Im Gespräch vergibst du Termine sofort aus deiner eigenen Availability – der Slot ist mit dem Eintrag wirklich blockiert.",
        "Ziel: Deine eingetragene Arbeitszeit ist mit Terminen komplett ausgelastet. Höchstens 10 zugewiesene Kunden gleichzeitig in der Pipeline – Termine zählen separat.",
