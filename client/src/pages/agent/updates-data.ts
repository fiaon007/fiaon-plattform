...
export const AGENT_UPDATES: AgentUpdate[] = [
  ...
  },
  {
    ...
    date: "2026-08-27",
    category: "Behoben",
    title: "Euer Feedback vom 27.08. — 19 Punkte, an einem Tag umgesetzt",
    summary: "Startgespräch-Kreislauf beendet, Terminart bleibt wie gewählt, Absagen mailen den Kunden, Vorwahlen repariert, Suche im Geld-Bereich, Bonitätsauskunft aus der Akte, Gesprächsübersicht — und die Leitfäden sind jetzt vier Gespräche.",
    changes: [
      "Startgespräch-Kreislauf beendet: In der Akte gibt es „Startgespräch geführt ✓“ — ein Klick hält das Telefonat fest und schaltet das Konto voll frei. Der Kunde sieht die Buchungs-Tafel danach nie wieder. (Cockpit-Abschluss wirkt wie bisher.)",
      "Kalender: Ein als „Onboarding“ angelegter Termin BLEIBT Onboarding — die Umdeutung in Vertrieb ist behoben. Und der Klick auf einen Termin führt in den richtigen Raum: Onboarding ins Cockpit, Zahlung ins Forderungsmanagement, Vertrieb in die Akte.",
      "Sagst du einen Termin ab, bekommt der Kunde jetzt automatisch eine Mail — mit Datum des abgesagten Termins und einem Link für eine neue Zeit. (Die Brevo-Vorlage legt die Leitung an; das Ereignis feuert bereits.)",
      "69 Kunden aus AT/CH hatten die deutsche Vorwahl an ihrer Handynummer — deshalb schlugen Anrufe fehl (u. a. Julia Rogel, Marija Dodos). Alle repariert; der Wählweg erkennt den Widerspruch jetzt selbst.",
      "„Kunde existiert nicht“ beim Notiz-Speichern ist behoben: Dokumentieren darf jetzt jeder, der den Kunden rechtmäßig bearbeitet (Onboarding, Forderungsmanagement, Leitung, Pool) — nicht nur der Betreuer.",
      "Unzugewiesene Kunden sind Pool: Die falsche Sperre „wird von jemand anderem betreut“ bei Kunden OHNE Betreuer ist weg. Betreuer-Anzeige ist jetzt überall dieselbe (Management = Telefon).",
      "Geld-Bereich im Management hat eine Suche (Name, Referenz, Betreuer).",
      "Bonitätsauskunft direkt aus der Akte bestellen: Knopf „Bonitätsauskunft bestellen“ — der Kunde muss nur noch überweisen. Danach „Zahlungsdaten senden“.",
      "Neue „Gesprächsübersicht“ in der Akte: Stand, Zahlungen, Unterlagen, Karte, nächster Termin und letzte Einträge auf einen Blick — ein Klick, bevor du wählst.",
      "Ratenanzeige repariert: „0 von 2“ trotz bezahltem Paket (z. B. Dirk Ladewig) ist behoben — die Startzahlung zählt jetzt immer, sobald das Paket bankbestätigt bezahlt ist.",
      "Dokument-Upload aus der Akte landet jetzt sicher beim RICHTIGEN Kunden (vorher konnte eine offene Als-Kunde-Sitzung den Upload umleiten). WhatsApp-Fotos (JPG/PNG) werden automatisch zu PDF.",
      "„Angaben im Antrag fehlen“, obwohl unter Daten alles steht: dritte und letzte Quelle dieses Fehlers abgedichtet (Karten-Tor liest jetzt auch die Person).",
      "Mitarbeiter- und Kundenansicht sagen zur Karte jetzt DASSELBE — die Kachel im Kundenportal liest denselben Stand wie deine Akte.",
      "Kundenportal hat einen Termine-Bereich: Der Kunde sieht seine Termine, kann absagen und selbst eine neue Zeit wählen — die Gesprächsart bestimmt sein Zustand, nie wieder ein erledigtes Startgespräch.",
      "Die verpassten Wochenend-Termine von Hans-Jürgen und Diana (21.–24.08., Plattform-Umbau) sind neutralisiert — sie gelten nicht als versäumt.",
      "Akademie: Provisionsauszahlung heißt jetzt überall richtig „alle zwei Wochen“ (stand fälschlich monatlich).",
      "Leitfäden neu geordnet: VIER Gespräche (Vertrieb mit Antrag, Vertrieb Lead, Onboarding, Collections) mit Situationen darunter — inklusive zwei neuer Leitfäden für Startgespräch und überfällige Rate. Die Frage ist nur noch: Welches Gespräch führe ich gerade?",
      "Demo-Rundgang: Das Erklärfenster weicht jetzt zur Seite aus, statt den erklärten Bereich zu verdecken.",
    ],
    howto: [
      "Startgespräch am Telefon geführt, ohne Termin? Akte öffnen → „Startgespräch geführt ✓“ — fertig, Konto ist frei.",
      "Onboarding-Termin im Kalender? Draufklicken — du landest direkt im Cockpit beim richtigen Kunden.",
      "Kunde will die Auskunft? Akte → „Bonitätsauskunft bestellen“ → „Zahlungsdaten senden“. Er überweist, die Zentrale bucht.",
      "Vor jedem Anruf: „Gesprächsübersicht“ in der Akte — alles Wichtige auf einen Blick.",
    ],
    link: { href: "/agent/academy/leitfaeden", label: "Die vier Gespräche ansehen" },
    important: true,
  },
  {
  ...
  },
  {
    ...
    changes: [
      ...
      "ZAHLUNGSDATEN: In Kunden-Mails steht jetzt das richtige Konto — FIAON LTD — seit 02.09.2026 NEU: DE86 2022 0800 0047 7193 24, BIC SXPYDEHH (Banking Circle); das alte Wise-Konto BE09… ist gesperrt. Wenn ein Kunde nach der Bankverbindung fragt, ist die aus dem System immer die richtige. Wer VOR dem 02.09. noch auf das Wise-Konto überwiesen hat, bekommt das Geld voraussichtlich als Rückläufer zurück — im Gespräch ruhig erklären und die neue Bankverbindung nennen (steht in jeder Zahlungsmail und auf der Zahlungsseite).",
