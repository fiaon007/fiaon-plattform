...
const FRAGEN = [
  ...
  { f: "Wie oft wird der Score neu berechnet?", a: "SCHUFA-Scores werden in Abständen neu gerechnet (der Basisscore quartalsweise, branchenspezifische Scores bei Abfrage). Eine Löschung oder Berichtigung wirkt deshalb nicht am selben Tag — aber verlässlich beim nächsten Rechenlauf. Wer im Oktober aufräumt, geht mit besseren Zahlen ins neue Jahr." },
