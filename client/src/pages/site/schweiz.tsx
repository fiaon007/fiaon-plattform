// 02.09.2026: zweisprachig — /schweiz und /en/switzerland; Texte im Wörterbuch
// client/src/i18n/laender.ts (Block „schweiz"), Bühne: Zürich bei Nacht.
...
export default function Schweiz() {
  const t = useWoerter(LAENDER_WOERTER).schweiz;
