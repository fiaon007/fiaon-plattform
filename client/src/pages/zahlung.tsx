...
// ═══════════════════════════════════════════════════════════════════════════
// DAS KLEINE WÖRTERBUCH DIESER SEITE (17.09.2026, E-188)
//
...
//
// „de" ist wörtlich der Bestand: Privatkunden und Monatsraten lesen diese Seite
// unverändert. „en" ist britisches Englisch und gilt NUR für den Firmenauftrag;
// alles, was nur die Privatkundenlinie zeigt (Konto aktivieren, Terminkachel,
// Sofortzahlung), steht deshalb nicht hier.
// ═══════════════════════════════════════════════════════════════════════════
const WORTE = {
  de: {
    zahlen: "de-DE",
