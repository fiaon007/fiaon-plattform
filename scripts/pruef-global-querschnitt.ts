...
const BASIS = process.env.PRUEF_BASIS || "e70a481";
...
ok(["global_auftrag", "global_zahlung_erinnerung", "global_start", "global_stichtag", "global_zugang"].every((e) => ereignisse.includes(e)), `Vorlagen fehlen: ${ereignisse.join(", ")}`);
