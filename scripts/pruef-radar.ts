...
import { RADAR_BEREICHE, RADAR_STATUS, radarDomain, alsRadarLand, radarBereich } from "../shared/fiaon-radar";
...
const { namensWoerter, nameAufSeite, aufhaengerPruefen, mailPruefen, mailHtml, mailText, anredeFuer, seitenWaehlen, ausJson, zeileLesen } = await import("../server/lib/fiaon-radar");
...
ok(Object.keys(RADAR_STATUS).length === 8, "Acht Stände");
