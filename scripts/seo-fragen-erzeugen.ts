...
const QUELLEN: Record<string, string> = {
  ...
  "client/src/i18n/wz-bonitaetsindex.ts": "/werkzeuge/bonitaetsindex|/en/tools/business-credit-index",
  "client/src/i18n/wz-verzugszinsen.ts": "/werkzeuge/verzugszinsen|/en/tools/late-payment-interest",
  "client/src/i18n/wz-skonto.ts": "/werkzeuge/skonto|/en/tools/early-payment-discount",
  "client/src/i18n/wz-firmenkarte.ts": "/werkzeuge/firmenkarte|/en/tools/business-card-check",
  "client/src/i18n/wz-firmenauskunft.ts": "/werkzeuge/firmenauskunft|/en/tools/business-credit-report",
  "client/src/i18n/wz-ratenplan.ts": "/werkzeuge/ratenplan|/en/tools/instalment-plan",
  "client/src/i18n/wz-hub.ts": "/werkzeuge|/en/tools",
  "client/src/i18n/status.ts": "/status|/en/status",
  "client/src/i18n/karriere.ts": "/karriere|/en/careers",
  "client/src/i18n/partner.ts": "/partner|/en/partners",
  "client/src/i18n/presse.ts": "/presse|/en/press",
