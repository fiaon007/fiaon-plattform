...
import { globalMeinAuftragPfad } from "@shared/fiaon-global-wege";
...
export type GlobalMail = "global_auftrag" | "global_start" | "global_stichtag" | "global_zahlung_erinnerung" | "global_zugang";
...
export function globalMailNutzlast(
  ...
  return {
    ...
    mein_auftrag_url: ref && opts.token ? absoluteUrl(globalMeinAuftragPfad(ref, opts.token)) : "",
...
// ── Für die Nachbarn dieses Bestellwegs (Zahlungstakt, Zugang, Storno) ───────
// Dieselben Leser und derselbe Verlaufseintrag wie oben — unter einem Namen, der
// außerhalb dieser Datei sagt, wozu er gehört.
export { bestellungLesen as globalBestellungLesen, verlauf as globalVerlauf, eur as globalEur };
