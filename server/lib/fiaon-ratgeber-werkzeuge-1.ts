...
Ein Wort zu den Kosten, weil sie den Streit so oft entscheiden: Die Deckelung nach § 13e RDG bindet Inkassokosten an das Rechtsanwaltsvergütungsgesetz. Für eine Forderung bis 500 Euro beträgt die einfache Gebühr nach der Tabelle 49 Euro; bei einer unbestrittenen Forderung sind nach § 13e Abs. 1 RDG höchstens 0,9 davon erstattungsfähig – rund 44 Euro zuzüglich Auslagenpauschale –, bei Zahlung nach der ersten Mahnung nur 0,5 – rund 24,50 Euro. Für Hauptforderungen bis 50 Euro gilt in jedem Fall nur die 0,5-Gebühr. Wer in einem Brief über 60 Euro Hauptforderung 120 Euro Inkassokosten liest, hat damit den Maßstab.
