...
import { KEIN_ABO_SQL } from "./fiaon-kein-abo";
  ...
  const kandidaten = (await sqlPool`
    ...
    SELECT a.ref, a.person_id, a.first_name, a.email, a.payment_reference,
     ...
     WHERE a.payment_status = 'paid'
       ...
       -- E-188: Ein Einmalkauf des Katalogs (FIAON Global, Bonitätsauskunft) hat
       -- keine Monatsrate — eine Einladung zum Bankeinzug wäre sinnlos und falsch.
