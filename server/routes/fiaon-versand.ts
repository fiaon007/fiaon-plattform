          ...
          : art === "termin_verpasst"
            ...
            : art === "sepa_einrichten"
              ? {
                  ...
                  // Der Knopf nimmt jetzt `sepa_link` und führt damit nicht mehr
                  // ins Dashboard, sondern direkt in die Mandatsstrecke; der
                  // Kundenbereich bleibt nur noch Rückfallweg ohne Referenz.
