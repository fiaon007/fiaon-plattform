...
export const KOSTEN: GlobalSeite[] = [
  {
    ...
    bloecke: [
      ...
      },
      {
        ...
        fuss: ["Registered Agent und US-CPA: veröffentlichte Preise mehrerer Anbieter, September 2026 — keine amtlichen Werte. Die Beträge für Ihre Gesellschaft nennen wir Ihnen rechtzeitig vorab."],
      },
      {
