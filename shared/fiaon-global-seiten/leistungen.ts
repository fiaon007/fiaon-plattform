...
export const LEISTUNGEN: GlobalSeite[] = [
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    fragen: [
      ...
      { f: "Spart eine US-Gesellschaft Steuern?", a: "In der Regel nicht. Wird die Gesellschaft aus Deutschland, Österreich oder der Schweiz geführt, ist sie dort steuerpflichtig, und in den USA kommen jährliche Meldepflichten hinzu. Eine US-Gesellschaft lohnt sich für echtes Geschäft in den USA — nicht als Steuermodell." },
    ],
