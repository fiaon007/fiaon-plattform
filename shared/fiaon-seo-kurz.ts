...
export const SEO_KURZ: Record<string, SeoKurz> = {
  ...
  "/bonitaetsauskunft-beantragen": {"titel":"Bonitätsauskunft beantragen: kostenlos oder geprüft","beschreibung":"Kostenlos nach Art. 15 DSGVO selbst anfordern oder für 74 € geprüft beschaffen lassen: Ablauf, Unterschied und der nächste Schritt.","sprache":"de","schwester":"/en/request-your-credit-report"},
  ...
  "/en/credit-glossary": {"titel":"Credit glossary: every term explained | FIAON","beschreibung":"Score class, data copy, deletion period, court payment order: the credit glossary explains every term in plain language, with the route to depth.","sprache":"en","schwester":"/glossar-bonitaet"},
  ...
  "/en/partners": {"titel":"Become a partner: banks, credit bureaus, introducers | FIAON","beschreibung":"For banks, credit bureaus, creditors and introducers: FIAON hands you a repaired, documented customer file – with written consent.","sprache":"en","schwester":"/partner"},
  ...
  "/en/tools/overdraft-calculator": {"titel":"Overdraft calculator: what the minus costs | FIAON","beschreibung":"Enter your balance and rate: see what a permanent minus costs over a year, what a fixed monthly reduction takes, which exit saves more.","sprache":"en","schwester":"/werkzeuge/dispo-rechner"},
  ...
  "/en/tools/reply-to-debt-collector": {"titel":"Reply to the debt collector: dispute, demand evidence","beschreibung":"Got a debt collection letter? Pick your situation and the generator writes the German reply: evidence under Section 13a RDG, costs, limitation.","sprache":"en","schwester":"/werkzeuge/inkasso-antwort"},
  ...
  "/ratgeber": {"titel":"Ratgeber: SCHUFA, Bonität, Inkasso erklärt | FIAON","beschreibung":"Ratgeber zu SCHUFA, KSV1870 und CRIF: Einträge verstehen, Auskunft kostenlos anfordern, Bonität einordnen. Geprüft, ohne leere Versprechen."},
