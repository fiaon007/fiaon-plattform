...
export const SEO_SEITEN: Record<string, SeoSeite> = {
  ...
  "/": {
    ...
    en: {
      ...
      abschnitte: [
        ...
        { h2: "What it costs", text: "Monthly plans in twelve instalments, cancellable at any time to the end of the current month. Just the credit report on its own is available as a one-off purchase. No commission on limits, no fee per letter.", punkte: ["Every instalment by bank transfer", "A named contact person in every plan", "The German application takes about two minutes"] },
  ...
  // 17.09.2026 (E-188): /business IST FIAON Global — die US-Struktur für
  ...
  "/preise": {
    ...
    abschnitte: [
      ...
      { h2: "Der Zahlungsweg – Schritt für Schritt.", text: "Antrag und Vertrag, erste Rate per Überweisung (bankbestätigt, dann Startgespräch), ab Monat zwei jede weitere Rate ebenfalls per Überweisung, kündbar jederzeit zum Monatsende, formlos. Keine Vorkasse für Leistungen, die noch nicht erbracht sind." },
  ...
  "/sicherheit": {
    ...
    en: {
      ...
      abschnitte: [
        { h2: "Five principles", text: "Authorisation: no report without your signature. Approval: no letter without you. Purpose limitation: your data serves your file, never advertising. Access: every access logged. Deletion: complete on request after the contract ends. Payments are made by bank transfer to the business account of FIAON LTD; no card data at FIAON." },
  ...
  "/ratenzahlung-und-bonitaet": {
    ...
    abschnitte: [
      ...
      { h2: "Der FIAON-Zahlungskalender", text: "Für Kunden eingebaut: keine Rate ohne Erinnerung – zwei Tage vor jeder Fälligkeit, im Kundenbereich und per E-Mail." },
    ],
