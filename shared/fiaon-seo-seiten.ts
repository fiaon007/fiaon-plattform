...
export const SEO_SEITEN: Record<string, SeoSeite> = {
  ...
  "/business/start": { pfad: "/business/start", art: "intern", stand: "2026-09-17", prio: 0.1, robots: "noindex,follow", titel: "Auftrag — FIAON Global", beschreibung: "FIAON Global direkt beauftragen: Paket wählen, Unternehmen eintragen, Vertrag am Bildschirm unterschreiben.", h1: "Ihr Auftrag in vier Schritten", lead: "Paket wählen, Unternehmen eintragen, Vertrag unterschreiben. Vertrag und Rechnung erhalten Sie per E-Mail." },
