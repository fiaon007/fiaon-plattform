...
export const SEO_WERKZEUGE: { pfad: string; name: string; frage: string; satz: string }[] = [
  ...
  // 09.09.2026 (E-099): fünf Werkzeuge für Firmenkunden.
  { pfad: "/werkzeuge/bonitaetsindex", name: "Bonitätsindex-Deuter", frage: "Was bedeutet meine Firmennote?", satz: "Index von 100 bis 600 einordnen — mit der veröffentlichten Ausfallwahrscheinlichkeit und den Merkmalen, die am schwersten wiegen." },
  { pfad: "/werkzeuge/verzugszinsen", name: "Verzugsrechner für Firmen", frage: "Rechnung überfällig – was steht mir zu?", satz: "Zinsen mit neun Punkten über dem Basiszins, die 40-Euro-Pauschale und die fertige Nachforderung." },
  { pfad: "/werkzeuge/skonto", name: "Skonto-Rechner", frage: "Skonto ziehen oder Ziel ausnutzen?", satz: "Skonto als Jahreszins gerechnet und gegen den Kontokorrent gestellt — in beide Richtungen." },
  { pfad: "/werkzeuge/firmenkarte", name: "Firmenkarten-Check", frage: "Was fehlt vor dem Kartenantrag?", satz: "Rechtsform, Alter, Offenlegung, Konto und Einträge — die Lücken in der Reihenfolge, in der sie sich schließen lassen." },
  { pfad: "/werkzeuge/firmenauskunft", name: "Firmenauskunft-Fahrplan", frage: "Wer speichert was über meine Firma?", satz: "Zuständige Stellen, das Recht je Rechtsform — und das fertige Schreiben an die Auskunftei." },
];
...
export const SEO_SEITEN: Record<string, SeoSeite> = {
  ...
  // 09.09.2026 (E-099): Werkzeuge für Firmenkunden.
  "/werkzeuge/bonitaetsindex": { pfad: "/werkzeuge/bonitaetsindex", art: "werkzeug", stand: PFEILER, prio: 0.8, werkzeug: "Bonitätsindex-Deuter",
    titel: "Bonitätsindex-Deuter: Was Ihre Firmennote bedeutet",
    beschreibung: "Bonitätsindex von 100 bis 600 eingeben – der Deuter nennt Klasse, Ausfallwahrscheinlichkeit und die Merkmale mit dem größten Gewicht.",
    h1: "Ihr Bonitätsindex: Was diese drei Ziffern auslösen",
    ...
    abschnitte: [
      { h2: "Niedrig ist gut – anders als beim Score", text: "Die Skala läuft von 100 für sehr gute Bonität bis 600 für Zahlungseinstellung; die Werte 500 und 600 gelten bei Creditreform als Ausfall. Wer den SCHUFA-Score für Privatpersonen gewohnt ist, liest die Zahl zunächst falsch herum – dort ist ein hoher Wert der bessere." },
      { h2: "Die Hälfte der Note liegt in Ihrer Hand", text: "Creditreform veröffentlicht die Gewichtung der zwölf Merkmale. Zahlungsweise und Krediturteil tragen je 25 Prozent, zusammen also die Hälfte. Struktur wie Rechtsform, Alter oder Mitarbeiterzahl wiegt je vier Prozent – daran ändert kein Gespräch etwas, an der Zahlungsweise schon." },
      { h2: "Was der Deuter nicht behauptet", text: "Veröffentlicht ist die Gewichtung, nicht die Formel. Das Werkzeug ordnet Ihren Wert deshalb ein und zeigt die Merkmale – es rechnet keinen neuen Index aus und sagt keine Kreditlinie voraus. Über Limits entscheidet der Lieferant oder die Bank." },
    ],
    weiter: ["/business", "/werkzeuge/firmenauskunft", "/werkzeuge/verzugszinsen", "/werkzeuge/firmenkarte", "/werkzeuge"],
    krumen: [{ name: "Werkzeuge", pfad: "/werkzeuge" }, { name: "Bonitätsindex-Deuter", pfad: "/werkzeuge/bonitaetsindex" }],
    en: {
      pfad: "/en/tools/business-credit-index",
      titel: "Business credit index reader: what your rating means",
      beschreibung: "Enter an index from 100 to 600 – the reader gives the class, the probability of default and the features that carry the most weight.",
      h1: "Your business credit index: what those three digits trigger",
      ...
      weiter: ["/business", "/werkzeuge/firmenauskunft", "/werkzeuge/verzugszinsen", "/werkzeuge/firmenkarte", "/werkzeuge"],
      krumen: [{ name: "Tools", pfad: "/en/tools" }, { name: "Business credit index reader", pfad: "/en/tools/business-credit-index" }],
    },
  },
  "/werkzeuge/verzugszinsen": { pfad: "/werkzeuge/verzugszinsen", art: "werkzeug", stand: PFEILER, prio: 0.8, werkzeug: "Verzugsrechner für Firmen",
    titel: "Verzugsrechner für Firmen: Zinsen und 40-Euro-Pauschale",
    beschreibung: "Betrag und Daten eingeben – der Rechner ermittelt Verzugszinsen mit neun Punkten über dem Basiszins, die 40-Euro-Pauschale und den Brieftext.",
    h1: "Ihr Geschäftskunde zahlt nicht. Das steht Ihnen zu.",
    ...
    abschnitte: [{ h2: "Neun Punkte statt fünf", text: "Gegenüber Verbrauchern sind es fünf Prozentpunkte über dem Basiszinssatz, zwischen Unternehmen neun (§ 288 Abs. 2 BGB). Bei einem Basiszins von 1,52 Prozent seit dem 1. Juli 2026 sind das 10,52 Prozent im Jahr – ein Satz, den kaum ein Kontokorrent erreicht." }, { h2: "Die 40 Euro sind nicht verhandelbar", text: "Je Entgeltforderung entsteht eine Pauschale von 40 Euro (§ 288 Abs. 5 BGB). Eine Klausel, die sie ausschließt, gilt im Zweifel als grob unbillig und ist unwirksam (§ 288 Abs. 6 BGB). Angerechnet wird sie nur auf spätere Kosten der Rechtsverfolgung." }, { h2: "Ab wann die Uhr läuft", text: "Nicht ab Rechnungsdatum. Entweder ab dem Tag nach einer kalendermäßig bestimmten Frist, ab dem Tag nach einer Mahnung – oder spätestens 30 Tage nach Fälligkeit und Rechnungszugang (§ 286 Abs. 3 BGB)." }],
    weiter: ["/business", "/werkzeuge/bonitaetsindex", "/werkzeuge/firmenauskunft", "/werkzeuge/firmenkarte", "/werkzeuge"],
    krumen: [{ name: "Werkzeuge", pfad: "/werkzeuge" }, { name: "Verzugsrechner für Firmen", pfad: "/werkzeuge/verzugszinsen" }],
    en: {
      pfad: "/en/tools/late-payment-interest",
      titel: "Late payment calculator for companies: interest and 40 euro",
      beschreibung: "Enter the amount and the dates – the calculator gives interest at nine points above base rate, the 40-euro fixed sum and the demand text.",
      h1: "Your business customer is not paying. Here is what you are owed.",
      ...
      weiter: ["/business", "/werkzeuge/bonitaetsindex", "/werkzeuge/firmenauskunft", "/werkzeuge/firmenkarte", "/werkzeuge"],
      krumen: [{ name: "Tools", pfad: "/en/tools" }, { name: "Late payment calculator", pfad: "/en/tools/late-payment-interest" }],
    },
  },
  "/werkzeuge/skonto": { pfad: "/werkzeuge/skonto", art: "werkzeug", stand: PFEILER, prio: 0.8, werkzeug: "Skonto-Rechner",
    titel: "Skonto-Rechner: Was zwei Prozent wirklich wert sind",
    beschreibung: "Skontosatz, Frist und Zahlungsziel eingeben – der Rechner nennt den effektiven Jahreszins und stellt ihn gegen Ihren Kontokorrent.",
    h1: "Zwei Prozent Skonto sind kein kleiner Rabatt",
    ...
    abschnitte: [{ h2: "Der Zinssatz hinter dem Rabatt", text: "Zwei Prozent für zwanzig gewonnene Tage entsprechen rund 37 Prozent im Jahr. Der Rechner nutzt die genaue Formel mit Bezug auf den tatsächlich gezahlten Betrag, nicht die Faustformel – sie liegt systematisch etwas zu niedrig." }, { h2: "Beide Richtungen", text: "Als Zahler vergleicht der Rechner das Skonto mit Ihrem Kontokorrentzins. Als Anbieter zeigt er, was Sie das frühere Geld im Jahr kostet – meist mehr als jede Kreditlinie." }, { h2: "Was ein Zahlungsziel darf", text: "Über 60 Tage hinaus ist eine Vereinbarung zwischen Unternehmen nur wirksam, wenn sie ausdrücklich getroffen und nicht grob unbillig ist (§ 271a Abs. 1 BGB). Gegenüber öffentlichen Auftraggebern sind mehr als 60 Tage unwirksam." }],
    weiter: ["/business", "/werkzeuge/bonitaetsindex", "/werkzeuge/firmenauskunft", "/werkzeuge/firmenkarte", "/werkzeuge"],
    krumen: [{ name: "Werkzeuge", pfad: "/werkzeuge" }, { name: "Skonto-Rechner", pfad: "/werkzeuge/skonto" }],
    en: {
      pfad: "/en/tools/early-payment-discount",
      titel: "Early payment discount calculator: what 2 % is really worth",
      beschreibung: "Enter the discount rate, period and payment term – the calculator gives the effective annual rate and sets it against your overdraft.",
      h1: "Two per cent discount is no small rebate",
      ...
      weiter: ["/business", "/werkzeuge/bonitaetsindex", "/werkzeuge/firmenauskunft", "/werkzeuge/firmenkarte", "/werkzeuge"],
      krumen: [{ name: "Tools", pfad: "/en/tools" }, { name: "Discount calculator", pfad: "/en/tools/early-payment-discount" }],
    },
  },
  "/werkzeuge/firmenkarte": { pfad: "/werkzeuge/firmenkarte", art: "werkzeug", stand: PFEILER, prio: 0.8, werkzeug: "Firmenkarten-Check",
    titel: "Firmenkarten-Check: Was vor dem Antrag noch fehlt",
    beschreibung: "Rechtsform, Alter, Jahresabschluss, Geschäftskonto und Einträge prüfen – der Check nennt die Lücken in der Reihenfolge zum Abarbeiten.",
    h1: "Firmenkarte beantragen: Was vorher auf dem Tisch liegen muss",
    ...
    abschnitte: [{ h2: "Sechs Fragen, keine Punktzahl", text: "Der Check zählt, welche der üblicherweise verlangten Unterlagen fehlt. Eine Prozentangabe gibt es bewusst nicht: Über Karte und Rahmen entscheidet das Kartenunternehmen nach eigenen Regeln, die keine Auskunftei kennt." }, { h2: "Der Jahresabschluss ist öffentlich", text: "Kapitalgesellschaften müssen binnen eines Jahres nach dem Abschlussstichtag an das Unternehmensregister übermitteln (§ 325 HGB). Eine fehlende Offenlegung sieht jeder – und sie wirkt über die Bilanzbonität auf den Bonitätsindex." }, { h2: "Erst die Auskunft, dann der Antrag", text: "Jede Kreditanfrage bleibt zwölf Monate gespeichert. Mehrere Kartenanträge in kurzer Folge sind für die nächste Bank ein Muster; eine Konditionsanfrage bleibt dagegen ohne Wirkung." }],
    weiter: ["/business", "/werkzeuge/bonitaetsindex", "/werkzeuge/firmenauskunft", "/werkzeuge/firmenkarte", "/werkzeuge"],
    krumen: [{ name: "Werkzeuge", pfad: "/werkzeuge" }, { name: "Firmenkarten-Check", pfad: "/werkzeuge/firmenkarte" }],
    en: {
      pfad: "/en/tools/business-card-check",
      titel: "Business card check: what is missing before you apply",
      beschreibung: "Check legal form, company age, annual accounts, business account and entries – the check names the gaps in the order they are best closed.",
      h1: "Applying for a business card: what has to be on the table first",
      ...
      weiter: ["/business", "/werkzeuge/bonitaetsindex", "/werkzeuge/firmenauskunft", "/werkzeuge/firmenkarte", "/werkzeuge"],
      krumen: [{ name: "Tools", pfad: "/en/tools" }, { name: "Business card check", pfad: "/en/tools/business-card-check" }],
    },
  },
  "/werkzeuge/firmenauskunft": { pfad: "/werkzeuge/firmenauskunft", art: "werkzeug", stand: PFEILER, prio: 0.8, werkzeug: "Firmenauskunft-Fahrplan",
    titel: "Firmenauskunft: Wer was über Ihr Unternehmen speichert",
    beschreibung: "Der Fahrplan nennt die zuständigen Auskunfteien, das anwendbare Auskunftsrecht für Firma und Inhaber – und formuliert das Schreiben.",
    h1: "Wer speichert was über Ihr Unternehmen?",
    lead: "Über die meisten Betriebe führen drei bis vier Stellen gleichzeitig einen Datensatz – und der Inhaber steht oft mit drin. Der Fahrplan nennt die zuständigen Stellen, klärt, welches Auskunftsrecht in Ihrem Fall greift, und schreibt den Brief.",
    abschnitte: [{ h2: "Die Rechtsform entscheidet über Ihr Recht", text: "Die DSGVO schützt natürliche Personen, nicht juristische (Erwägungsgrund 14). Beim Einzelunternehmen greift Art. 15 DSGVO deshalb voll, bei der GmbH nur für Sie persönlich – Einsicht in den Firmendatensatz gewähren die Auskunfteien daneben freiwillig." }, { h2: "Drei bis vier Stellen gleichzeitig", text: "In Deutschland Creditreform, CRIF und die SCHUFA, dazu das öffentliche Unternehmensregister. In Österreich KSV1870 und CRIF, in der Schweiz CRIF, Intrum und der Betreibungsregisterauszug nach Art. 8a SchKG." }, { h2: "Der Satz, der einen Eintrag kippt", text: "§ 31 Abs. 2 BDSG lässt die Meldung einer offenen Forderung nur zu, wenn sie fällig ist, zwei Mahnungen mit vier Wochen Abstand vorausgingen, auf die Meldung hingewiesen wurde und die Forderung nicht bestritten ist. Fehlt eine Voraussetzung, ist der Eintrag angreifbar." }],
    weiter: ["/business", "/werkzeuge/bonitaetsindex", "/werkzeuge/firmenauskunft", "/werkzeuge/firmenkarte", "/werkzeuge"],
    krumen: [{ name: "Werkzeuge", pfad: "/werkzeuge" }, { name: "Firmenauskunft-Fahrplan", pfad: "/werkzeuge/firmenauskunft" }],
    en: {
      pfad: "/en/tools/business-credit-report",
      titel: "Business credit report: who holds what on your company",
      beschreibung: "The guide names the relevant credit agencies, the access right that applies to company and owner – and drafts the letter.",
      h1: "Who holds what on your company?",
      lead: "Three or four offices usually keep a record on the same business at once – and the owner is often in there too. The guide names them, establishes which access right applies in your case, and writes the letter.",
      weiter: ["/business", "/werkzeuge/bonitaetsindex", "/werkzeuge/firmenauskunft", "/werkzeuge/firmenkarte", "/werkzeuge"],
      krumen: [{ name: "Tools", pfad: "/en/tools" }, { name: "Business credit report guide", pfad: "/en/tools/business-credit-report" }],
    },
  },
  ...
  // 05.09.2026: der NEUE Kundenbereich unter /app (läuft parallel zu /login und
  // /mein-bereich, bis er fertig ist). Kein Suchziel — wie /login.
  "/app/login": { pfad: "/app/login", art: "intern", stand: "2026-09-05", prio: 0.1, robots: "noindex,follow", titel: "Anmelden — Mein FIAON", beschreibung: "Melden Sie sich in Ihrem FIAON-Kundenbereich an.", h1: "Ihr Weg zur Karte beginnt hier.", lead: "Ihr Ziel, Ihr Stand, Ihr nächster Schritt – auf einen Blick." },
  "/app": { pfad: "/app", art: "intern", stand: "2026-09-05", prio: 0.1, robots: "noindex,nofollow", titel: "Mein FIAON", beschreibung: "Ihr persönlicher FIAON-Bereich: Ziel, Stand und nächster Schritt.", h1: "Mein FIAON", lead: "Ihr Ziel, Ihr Stand, Ihr nächster Schritt – auf einen Blick." },
